                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8"><input type="text" name="status" class="form-control" value="{{ $tahap->status }}"></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8"><input type="text" name="status_pembinaan" class="form-control" value="{{ $tahap->tahap3->status_pembinaan }}"></dd>
