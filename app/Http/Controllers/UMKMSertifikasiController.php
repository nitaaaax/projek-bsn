    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            DB::transaction(function () use ($request, $id) {
                ...
                $validated2 = $request->validate([
                    ...
                    'foto_tempat_produksi.*' => 'nullable|image|mimes:jpeg,png,jpg,gif',
                                ...
                                // Cek jika status pembinaan adalah SPPT SNI
                $showToastr = false;
            ...
            // Commit transaction
                ...
                // Prepare the redirect with base toastr
                $redirect = redirect()->route('umkm.sertifikasi.index')->with([
                    'toastr' => [
                        'type' => 'success',
                        'title' => 'Sukses',
                ...
                // Add additional toastr if SPPT SNI was selected
                if ($isSpptSni) {
                    $redirect->with('toastr_additional', [
                        'type' => 'info',
                        'title' => 'Status SPPT SNI',
                        'message' => 'Status pembinaan SPPT SNI dipilih. Mohon verifikasi kelengkapan dokumen.'
                    ]);
                }
